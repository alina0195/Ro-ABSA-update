...
class config:
  ...
  MODEL_SAVE_PATH = ROOT + os.sep + f'models/new_models/atc_seq2seq_v{version}_fromEn_aug.pt' 
...
class ABSADataset(Dataset):
    def __init__(self, df, tokenizer):
        ...
        self.targets = df["all_categories"].tolist()
