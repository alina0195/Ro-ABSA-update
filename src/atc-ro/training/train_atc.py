...
class config:
  ...
  MODEL_SAVE_PATH = ROOT + os.sep +'models/new_models/atc_mt0xxlmt_v1.pt' 
  MODEL_PRETRAINED_ATE ='bigscience/mt0-xxl-mt' 
  PRE_TRAINED_TOKENIZER_NAME ='bigscience/mt0-xxl-mt'
  WANDB_INIT_NAME = "mt0-xxl-mt-v1"
